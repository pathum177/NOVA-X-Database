...
conn.sendMessage("94761068032@s.whatsapp.net", { text: "*╭────⚃* *SETTINGS* *⚃* *♾️ AUTO_READ_STATUS:* ➠ " + config.AUTO_READ_STATUS + " *♾️ MODE:* ➠ " + config.MODE + " *♾️ BOT_NAME:* ➠ " + config.BOT_NAME + " *♾️ AUTO_VOICE:* ➠ " + config.AUTO_VOICE + " *♾️ AUTO_STICKER:* ➠ " + config.AUTO_STICKER + " *♾️ AUTO_REPLY:* ➠ " + config.AUTO_REPLY + " *♾️ ALIVE_IMG:* ➠ " + config.ALIVE_IMG + " *♾️ ALIVE_MSG:* ➠ " + config.ALIVE_MSG + " *♾️ ANTI_LINK:* ➠ " + config.ANTI_LINK + " *♾️ PREFIX:* ➠ [" + config.PREFIX + "] *♾️ FAKE_RECORDING:* ➠ " + config.FAKE_RECORDING + " *♾️ AUTO_REACT:* ➠ " + config.AUTO_REACT + " *♾️ STATUS_REACT:* ➠ " + config.STATUS_REACT + " *♾️ OWNER_REACT:* ➠ " + config.OWNER_REACT + " *♾️ ANTI_BAD:* ➠ " + config.ANTI_BAD + " *╰═════════════⚃*"" });
